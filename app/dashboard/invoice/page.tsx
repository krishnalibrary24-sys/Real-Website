    ...
    <div className="bg-white text-black min-h-screen p-8 md:p-16 max-w-4xl mx-auto font-sans" id="printable-invoice">
      <div className="border-2 border-black p-8 relative">
        ...
        <div className="flex justify-between items-start border-b-2 border-black pb-6 mb-6">
          <div>
            <h1 className="text-4xl font-black uppercase text-blue-900 tracking-tighter">Krishna Library</h1>
            <p className="text-gray-600 font-bold mt-1 uppercase text-sm tracking-widest">{member.branch.replace('-', ' ')} Branch</p>
